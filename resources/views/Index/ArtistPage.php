            ...
            <div class="main_menu" id="mainNav">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="assets/HalamanArtis/img/logo.png" alt=""></a>
				...
				<div class="projects_inner row">
					<div class="col-lg-4 col-sm-6 brand web">
						<div class="projects_item">
							<img class="img-fluid" src="assets/HalamanArtis/img/projects/projects-1.jpg" alt="">
							<div class="projects_text">
								<a href="assets/HalamanArtis/portfolio-details.html"><h4>3D Helmet Design</h4></a>
								<p>Client Project</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 brand work">
						<div class="projects_item">
							<img class="img-fluid" src="assets/HalamanArtis/img/projects/projects-2.jpg" alt="">
							<div class="projects_text">
								<a href="assets/HalamanArtis/portfolio-details.html"><h4>3D Helmet Design</h4></a>
								<p>Client Project</p>
							</div>
					...
					<div class="col-lg-4 col-sm-6 work">
						<div class="projects_item">
							<img class="img-fluid" src="assets/HalamanArtis/img/projects/projects-3.jpg" alt="">
							<div class="projects_text">
								<a href="assets/HalamanArtis/portfolio-details.html"><h4>3D Helmet Design</h4></a>
								<p>Client Project</p>
							</div>
					...
					<div class="col-lg-4 col-sm-6 brand web">
						<div class="projects_item">
							<img class="img-fluid" src="assets/HalamanArtis/img/projects/projects-4.jpg" alt="">
							<div class="projects_text">
								<a href="assets/HalamanArtis/portfolio-details.html"><h4>3D Helmet Design</h4></a>
								<p>Client Project</p>
							</div>
					...
					<div class="col-lg-4 col-sm-6 brand work">
						<div class="projects_item">
							<img class="img-fluid" src="assets/HalamanArtis/img/projects/projects-5.jpg" alt="">
							<div class="projects_text">
								<a href="assets/HalamanArtis/portfolio-details.html"><h4>3D Helmet Design</h4></a>
								<p>Client Project</p>
							</div>
					...
					<div class="col-lg-4 col-sm-6 brand work web">
						<div class="projects_item">
							<img class="img-fluid" src="assets/HalamanArtis/img/projects/projects-6.jpg" alt="">
							<div class="projects_text">
								<a href="assets/HalamanArtis/portfolio-details.html"><h4>3D Helmet Design</h4></a>
								<p>Client Project</p>
							</div>
        	...
        	<div class="container">
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-4">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="assets/HalamanArtis/img/blog/home-blog/home-blog-1.jpg" alt="">
        					</div>
        			...
        			<div class="col-lg-4">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="assets/HalamanArtis/img/blog/home-blog/home-blog-2.jpg" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
        			...
        			<div class="col-lg-4">
        				<div class="l_blog_item">
        					<div class="l_blog_img">
        						<img class="img-fluid" src="assets/HalamanArtis/img/blog/home-blog/home-blog-3.jpg" alt="">
        					</div>
        					<div class="l_blog_text">
        						<div class="date">
        							<a href="#">25 October, 2017  |  By Mark Wiens</a>
