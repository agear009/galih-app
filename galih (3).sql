...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Okt 2024 pada 00.45
...
(13, '20240923035725', 'lili', '5', 'peRBaE9BVTOMyizjVhl3MUcrTogTEDutuG2ZSByH.jpg', 'I4YitMHRfB1EYx50xFOuC5V2VRhWT3WiUvUIe1L4.mp3', 'kau selalu diam', 'belum terdapat pencipta_lagu', 'Jazz', '2024-10-30', '<p>belum terdapat tentang_artis</p>', '<p>belum terdapat lirik</p>', '<p>belum terdapat keterangan_lagu</p>', '#', '#', '#', '#', '#', '#', '#', '#', '#', '2024-09-23 08:57:26', '2024-10-13 02:22:47');
